...
class DataTrainingArguments:
    ...
    """
    is_use_skeleton: bool = field(default=False)
    train_data_dir: str = field(
        default='RQG/data/SQuAD_1.1_split1/processed/train.jsonl',
        metadata={"help": "The input data dir. Should contain the .tsv files (or other data files) for the task."}
    )
    valid_data_dir: str = field(
        default='RQG/data/SQuAD_1.1_split1/processed/dev.jsonl',
        metadata={"help": "The input data dir. Should contain the .tsv files (or other data files) for the task."}
    )
    test_data_dir: str = field(
        default='RQG/data/SQuAD_1.1_split1/processed/test.jsonl',
        metadata={"help": "The input data dir. Should contain the .tsv files (or other data files) for the task."}
    )
    ...
    n_train: Optional[float] = field(default=0.01, metadata={"help": "# training examples. -1 means use all."})
    n_val: Optional[float] = field(default=0.1, metadata={"help": "# validation examples. -1 means use all."})
    ...
    diversity_penalty: float=field(default=0.2)
    top_p: float = field(
        default=0.9,metadata={"help":"top_p"}
    )
    top_k: int = field(
...
class TrainingArguments(transformers.Seq2SeqTrainingArguments):
    ...
    output_dir: str = field(
        default='RQG/output/SQuAD_1.1_split1/QG/experiments_with_null_skeleton_v2',
